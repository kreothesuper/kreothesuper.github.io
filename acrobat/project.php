                        ...
                        <div class="container">
                            ...
                            <div class="projects__content">
                                ...
                                ?>
                                    ...
                                    ?>
                                    <a href="<?= get_field('outer_link') ? get_field('outer_link') : get_the_permalink(); ?>" <?= get_field('outer_link') ? 'target="_blank"' : ''; ?> class="card sort-grid__item" data-sort="<?= $term->term_id; ?>">
