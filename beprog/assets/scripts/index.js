...
const languageObject = {
    ...
    ru: [
        ...
        ['about-card-title-fourth', 'для неограниченной аудитории'],
    ...
    it: [
        ...
        ['about-card-title-fourth', 'per un pubblico illimitato'],
    ...
    fr: [
        ...
        ['about-card-title-fourth', 'pour un public illimité'],
        ['about-card-text-fourth', "L'application BeProg est sans publicité et sans spam"],
        ['banner-text', "L'application BeProg vous apportera la tranquillité d'esprit que seul l'anonymat peut procurer."],
